...
**Note**: These are proxy/readiness results using oracle-anchor geometry relation scores, NOT learned dense relation scorer. They prove the comparison pipeline works, but do not constitute method evidence.
