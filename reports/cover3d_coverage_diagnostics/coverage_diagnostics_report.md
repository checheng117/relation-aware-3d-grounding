...
- Manifest: `/home/cc/Project/CC/relation-aware-3d-grounding/data/processed/scene_disjoint/official_scene_disjoint/test_manifest.jsonl`
- Predictions: `/home/cc/Project/CC/relation-aware-3d-grounding/outputs/20260409_learned_class_embedding/formal/eval_test_predictions.json`
- Entity annotations: `/home/cc/Project/CC/relation-aware-3d-grounding/data/raw/referit3d/annotations/nr3d_annotations.json`
- Geometry dir: `/home/cc/Project/CC/relation-aware-3d-grounding/data/geometry`
- Annotation matches: `{'none': 3673, 'exact_utterance': 171, 'target_fallback': 411}`

## Topline

- Samples analyzed: **4255**
- Baseline Acc@1 / Acc@5: **30.79% / 91.75%**
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| same_class_clutter | 2373 | 268 | 21.41% | 36.94% | 50.37% | 73.13% | 88.81% | 4.44 |
| same_class_high_clutter | 697 | 144 | 15.78% | 37.50% | 57.64% | 75.00% | 89.58% | 4.38 |
| multi_anchor | 93 | 93 | 19.35% | 47.31% | 53.76% | 75.27% | 100.00% | 3.34 |
| relative_position | 968 | 118 | 29.24% | 27.12% | 40.68% | 68.64% | 82.20% | 5.39 |
| dense_scene | 752 | 82 | 29.39% | 30.49% | 53.66% | 79.27% | 81.71% | 4.77 |
| baseline_wrong | 2945 | 324 | 0.00% | 28.40% | 42.90% | 66.05% | 85.49% | 5.32 |
| baseline_correct | 1310 | 93 | 100.00% | 33.33% | 56.99% | 74.19% | 77.42% | 5.71 |
| annotation_exact | 171 | 121 | 26.32% | 33.88% | 52.07% | 72.73% | 87.60% | 4.65 |
| annotation_fallback | 411 | 296 | 24.82% | 27.70% | 43.58% | 65.88% | 82.09% | 5.72 |
