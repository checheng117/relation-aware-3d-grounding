...
- Manifest: `<repo>/data/processed/scene_disjoint/official_scene_disjoint/test_manifest.jsonl`
- Predictions: `<repo>/outputs/20260409_learned_class_embedding/formal/eval_test_predictions.json`
- Entity annotations: `<repo>/data/raw/referit3d/annotations/nr3d_annotations.json`
- Geometry dir: `<repo>/data/geometry`
